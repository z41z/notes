...
install(){
    ...
    echo -e "Shadowsocks IP        : \033[41;37m $(get_ip) \033[0m"
    echo -e "Shadowsocks Port      : \033[41;37m ${shadowsocksport} \033[0m"
    echo -e "Shadowsocks Password         : \033[41;37m ${shadowsockspwd} \033[0m"
    echo -e "Shadowsocks Encryption Method: \033[41;37m ${shadowsockscipher} \033[0m"
    echo
}
